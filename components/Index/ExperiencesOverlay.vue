...
const workContent = [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Implemented on-page SEO strategies and built backlinks to significantly boost organic traffic for websites.",
      "Improved website content with SEO techniques such as keyword research, meta tag optimization, and content structuring for better search engine visibility.",
      "Crafted engaging articles using AI tools (ChatGPT with AIPRM extension) and Grammarly, while managing a Blogspot platform for effective content publication.",
      "Utilized Ahrefs to analyze and track SEO performance, including keyword monitoring, competitor analysis, and backlink profile management.",
      "Leveraged Google Analytics to track and analyze user interactions with websites for performance insights.",
      "Implemented ADJust SDK for mobile app tracking and analytics to measure campaign effectiveness.",
    ],
  },
  {
